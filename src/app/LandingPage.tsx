          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <motion.div 
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 1 }}
                className="flex flex-col sm:flex-row gap-4 mt-8 pt-8 border-t border-slate-700/50"
              >
                <a 
                  href="https://myvibes-hazel.vercel.app/app?v=2.1.1&ts=1710346800" 
                  target="_blank" 
                ...
                >
                  <motion.div 
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="flex items-center gap-3 px-6 py-3 bg-black rounded-xl border border-slate-600 hover:border-cyan-500 transition-all"
                  >
                    ...
                    <div className="flex flex-col text-left">
                      ...
                      <span className="text-lg font-bold text-white -mt-1">App Store</span>
                    </div>
                  </motion.div>
                </a>

                <a 
                  href="https://play.google.com/store/apps/details?id=com.myvibes.app" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="group"
                >
                  ...
                  >
                    <svg className="w-8 h-8" viewBox="0 0 24 24">
                      <path fill="#00D9FF" d="M3,20.5V3.5C3,2.91 3.34,2.39 3.84,2.15L13.69,12L3.84,21.85C3.34,21.6 3,21.09 3,20.5Z"/>
                      <path fill="#00A3CC" d="M16.81,15.12L6.05,21.34L14.54,12.85L16.81,15.12Z"/>
                      <path fill="#FFD900" d="M20.16,10.81C20.5,11.08 20.75,11.5 20.75,12C20.75,12.5 20.53,12.9 20.18,13.18L17.89,14.5L15.39,12L17.89,9.5L20.16,10.81Z"/>
                      <path fill="#FF3E00" d="M6.05,2.66L16.81,8.88L14.54,11.15L6.05,2.66Z"/>
                    </svg>
                    <div className="flex flex-col text-left">
