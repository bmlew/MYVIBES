-- ============================================
-- MYVIBES PRODUCTION DATABASE MIGRATION
-- ============================================
...
-- 1. USERS TABLE (must be created first - referenced by businesses)
...
-- 2. BUSINESSES TABLE (references users)
...
-- 10. ANALYTICS_CLICKS TABLE (General click tracking)
...
-- ============================================
-- TRIGGER: Update loyalty points on check-in
-- ============================================
...
-- ============================================
-- TRIGGER: Update business rating on review
-- ============================================
...
SELECT 
    ...
    CASE 
        ...
        THEN ROUND((COUNT(DISTINCT c.id)::decimal / COUNT(DISTINCT r.id)) * 100, 2)
        ELSE 0 
    END as completion_rate,
    COUNT(DISTINCT sc.id) as special_clicks,
    b.created_at
FROM businesses b
...
-- MIGRATION COMPLETE
-- ============================================
-- After running this SQL, update your backend code
-- to use these new tables instead of kv_store
-- ============================================